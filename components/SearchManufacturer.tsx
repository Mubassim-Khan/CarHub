...
class SearchManufacturer extends Component<SearchManufacturerProps, { query: string }> {
  constructor(props: SearchManufacturerProps) {
    super(props);
    this.state = {
      query: "",
    };
  ...
  render() {
    const { manufacturer, setManufacturer } = this.props;
    const { query } = this.state;

    // Converting all manufacturers in lowercase & replacing all white spaces with '+'
